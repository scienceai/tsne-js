...
},{"cwise-compiler":4,"cwise-parser":8}],3:[function(require,module,exports){
...
},{"./lib/thunk.js":14,"dup":4}],13:[function(require,module,exports){
arguments[4][5][0].apply(exports,arguments)
},{"dup":5,"uniq":15}],14:[function(require,module,exports){
arguments[4][6][0].apply(exports,arguments)
},{"./compile.js":13,"dup":6}],15:[function(require,module,exports){
arguments[4][7][0].apply(exports,arguments)
...
},{"./doConvert.js":17,"ndarray":24}],17:[function(require,module,exports){
...
"use strict";function Procedure(){this.argTypes=[],this.shimArgs=[],this.arrayArgs=[],this.scalarArgs=[],this.offsetArgs=[],this.offsetArgIndex=[],this.indexArgs=[],this.shapeArgs=[],this.funcName="",this.pre=null,this.body=null,this.post=null,this.debug=!1}function compileCwise(r){var e=new Procedure;e.pre=r.pre,e.body=r.body,e.post=r.post;var s=r.args.slice(0);e.argTypes=s.slice(0);for(var o=0;o<s.length;++o){var t=s[o];if("array"===t){if(e.arrayArgs.push(o),e.shimArgs.push("array"+o),o<e.pre.args.length&&e.pre.args[o].count>0)throw new Error("cwise: pre() block may not reference array args");if(o<e.post.args.length&&e.post.args[o].count>0)throw new Error("cwise: post() block may not reference array args")}else if("scalar"===t)e.scalarArgs.push(o),e.shimArgs.push("scalar"+o);else if("index"===t){if(e.indexArgs.push(o),o<e.pre.args.length&&e.pre.args[o].count>0)throw new Error("cwise: pre() block may not reference array index");if(o<e.body.args.length&&e.body.args[o].lvalue)throw new Error("cwise: body() block may not write to array index");if(o<e.post.args.length&&e.post.args[o].count>0)throw new Error("cwise: post() block may not reference array index")}else if("shape"===t){if(e.shapeArgs.push(o),o<e.pre.args.length&&e.pre.args[o].lvalue)throw new Error("cwise: pre() block may not write to array shape");if(o<e.body.args.length&&e.body.args[o].lvalue)throw new Error("cwise: body() block may not write to array shape");if(o<e.post.args.length&&e.post.args[o].lvalue)throw new Error("cwise: post() block may not write to array shape")}else{if("object"!=typeof t||!t.offset)throw new Error("cwise: Unknown argument type "+s[o]);e.argTypes[o]="offset",e.offsetArgs.push({array:t.array,offset:t.offset}),e.offsetArgIndex.push(o)}}if(e.arrayArgs.length<=0)throw new Error("cwise: No array arguments specified");if(e.pre.args.length>s.length)throw new Error("cwise: Too many arguments in pre() block");if(e.body.args.length>s.length)throw new Error("cwise: Too many arguments in body() block");if(e.post.args.length>s.length)throw new Error("cwise: Too many arguments in post() block");return e.debug=!!r.printCode||!!r.debug,e.funcName=r.funcName||"cwise",e.blockSize=r.blockSize||64,createThunk(e)}var createThunk=require("./lib/thunk.js");module.exports=compileCwise;
},{"./lib/thunk.js":20}],19:[function(require,module,exports){
"use strict";function innerFill(r,n,e){var s,o,a=r.length,i=n.arrayArgs.length,t=n.indexArgs.length>0,u=[],h=[],p=0,l=0;for(s=0;a>s;++s)h.push(["i",s,"=0"].join(""));for(o=0;i>o;++o)for(s=0;a>s;++s)l=p,p=r[s],0===s?h.push(["d",o,"s",s,"=t",o,"[",p,"]"].join("")):h.push(["d",o,"s",s,"=(t",o,"[",p,"]-s",l,"*t",o,"[",l,"])"].join(""));for(u.push("var "+h.join(",")),s=a-1;s>=0;--s)p=r[s],u.push(["for(i",s,"=0;i",s,"<s",p,";++i",s,"){"].join(""));for(u.push(e),s=0;a>s;++s){for(l=p,p=r[s],o=0;i>o;++o)u.push(["p",o,"+=d",o,"s",s].join(""));t&&(s>0&&u.push(["index[",l,"]-=s",l].join("")),u.push(["++index[",p,"]"].join(""))),u.push("}")}return u.join("\n")}function outerFill(r,n,e,s){for(var o=n.length,a=e.arrayArgs.length,i=e.blockSize,t=e.indexArgs.length>0,u=[],h=0;a>h;++h)u.push(["var offset",h,"=p",h].join(""));for(var h=r;o>h;++h)u.push(["for(var j"+h+"=SS[",n[h],"]|0;j",h,">0;){"].join("")),u.push(["if(j",h,"<",i,"){"].join("")),u.push(["s",n[h],"=j",h].join("")),u.push(["j",h,"=0"].join("")),u.push(["}else{s",n[h],"=",i].join("")),u.push(["j",h,"-=",i,"}"].join("")),t&&u.push(["index[",n[h],"]=j",h].join(""));for(var h=0;a>h;++h){for(var p=["offset"+h],l=r;o>l;++l)p.push(["j",l,"*t",h,"[",n[l],"]"].join(""));u.push(["p",h,"=(",p.join("+"),")"].join(""))}u.push(innerFill(n,e,s));for(var h=r;o>h;++h)u.push("}");return u.join("\n")}function countMatches(r){for(var n=0,e=r[0].length;e>n;){for(var s=1;s<r.length;++s)if(r[s][n]!==r[0][n])return n;++n}return n}function processBlock(r,n,e){for(var s=r.body,o=[],a=[],i=0;i<r.args.length;++i){var t=r.args[i];if(!(t.count<=0)){var u=new RegExp(t.name,"g"),h="",p=n.arrayArgs.indexOf(i);switch(n.argTypes[i]){case"offset":var l=n.offsetArgIndex.indexOf(i),f=n.offsetArgs[l];p=f.array,h="+q"+l;case"array":h="p"+p+h;var c="l"+i,g="a"+p;1===t.count?"generic"===e[p]?t.lvalue?(o.push(["var ",c,"=",g,".get(",h,")"].join("")),s=s.replace(u,c),a.push([g,".set(",h,",",c,")"].join(""))):s=s.replace(u,[g,".get(",h,")"].join("")):s=s.replace(u,[g,"[",h,"]"].join("")):"generic"===e[p]?(o.push(["var ",c,"=",g,".get(",h,")"].join("")),s=s.replace(u,c),t.lvalue&&a.push([g,".set(",h,",",c,")"].join(""))):(o.push(["var ",c,"=",g,"[",h,"]"].join("")),s=s.replace(u,c),t.lvalue&&a.push([g,"[",h,"]=",c].join("")));break;case"scalar":s=s.replace(u,"Y"+n.scalarArgs.indexOf(i));break;case"index":s=s.replace(u,"index");break;case"shape":s=s.replace(u,"shape")}}}return[o.join("\n"),s,a.join("\n")].join("\n").trim()}function typeSummary(r){for(var n=new Array(r.length),e=!0,s=0;s<r.length;++s){var o=r[s],a=o.match(/\d+/);a=a?a[0]:"",0===o.charAt(0)?n[s]="u"+o.charAt(1)+a:n[s]=o.charAt(0)+a,s>0&&(e=e&&n[s]===n[s-1])}return e?n[0]:n.join("")}function generateCWiseOp(r,n){for(var e=0|n[1].length,s=new Array(r.arrayArgs.length),o=new Array(r.arrayArgs.length),a=["SS"],i=["'use strict'"],t=[],u=0;e>u;++u)t.push(["s",u,"=SS[",u,"]"].join(""));for(var h=0;h<r.arrayArgs.length;++h)a.push("a"+h),a.push("t"+h),a.push("p"+h),o[h]=n[2*h],s[h]=n[2*h+1];for(var h=0;h<r.scalarArgs.length;++h)a.push("Y"+h);if(r.shapeArgs.length>0&&t.push("shape=SS.slice(0)"),r.indexArgs.length>0){for(var p=new Array(e),h=0;e>h;++h)p[h]="0";t.push(["index=[",p.join(","),"]"].join(""))}for(var h=0;h<r.offsetArgs.length;++h){for(var l=r.offsetArgs[h],f=[],u=0;u<l.offset.length;++u)0!==l.offset[u]&&(1===l.offset[u]?f.push(["t",l.array,"[",u,"]"].join("")):f.push([l.offset[u],"*t",l.array,"[",u,"]"].join("")));0===f.length?t.push("q"+h+"=0"):t.push(["q",h,"=(",f.join("+"),")|0"].join(""))}var c=uniq([].concat(r.pre.thisVars).concat(r.body.thisVars).concat(r.post.thisVars));t=t.concat(c),i.push("var "+t.join(","));for(var h=0;h<r.arrayArgs.length;++h)i.push("p"+h+"|=0");r.pre.body.length>3&&i.push(processBlock(r.pre,r,o));var g=processBlock(r.body,r,o),j=countMatches(s);e>j?i.push(outerFill(j,s[0],r,g)):i.push(innerFill(s[0],r,g)),r.post.body.length>3&&i.push(processBlock(r.post,r,o)),r.debug&&console.log("Generated cwise routine for ",n,":\n\n",i.join("\n"));var v=[r.funcName||"unnamed","_cwise_loop_",s[0].join("s"),"m",j,typeSummary(o)].join(""),d=new Function(["function ",v,"(",a.join(","),"){",i.join("\n"),"} return ",v].join(""));return d()}var uniq=require("uniq");module.exports=generateCWiseOp;
...
"use strict";function unique_pred(n,e){for(var u=1,t=n.length,i=n[0],r=n[0],o=1;t>o;++o)if(r=i,i=n[o],e(i,r)){if(o===u){u++;continue}n[u++]=i}return n.length=u,n}function unique_eq(n){for(var e=1,u=n.length,t=n[0],i=n[0],r=1;u>r;++r,i=t)if(i=t,t=n[r],t!==i){if(r===e){e++;continue}n[e++]=t}return n.length=e,n}function unique(n,e,u){return 0===n.length?[]:e?(u||n.sort(e),unique_pred(n,e)):(u||n.sort(),unique_eq(n))}module.exports=unique;
...
},{"cwise/lib/wrapper":3,"dup":22}],24:[function(require,module,exports){
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,r){if(!(e instanceof r))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,r){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!r||"object"!=typeof r&&"function"!=typeof r?e:r}function _inherits(e,r){if("function"!=typeof r&&null!==r)throw new TypeError("Super expression must either be null or a function, not "+typeof r);e.prototype=Object.create(r&&r.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),r&&(Object.setPrototypeOf?Object.setPrototypeOf(e,r):e.__proto__=r)}function _toConsumableArray(e){if(Array.isArray(e)){for(var r=0,t=Array(e.length);r<e.length;r++)t[r]=e[r];return t}return Array.from(e)}var _createClass=function(){function e(e,r){for(var t=0;t<r.length;t++){var a=r[t];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(e,a.key,a)}}return function(r,t,a){return t&&e(r.prototype,t),a&&e(r,a),r}}(),_slicedToArray=function(){function e(e,r){var t=[],a=!0,n=!1,i=void 0;try{for(var u,s=e[Symbol.iterator]();!(a=(u=s.next()).done)&&(t.push(u.value),!r||t.length!==r);a=!0);}catch(o){n=!0,i=o}finally{try{!a&&s["return"]&&s["return"]()}finally{if(n)throw i}}return t}return function(r,t){if(Array.isArray(r))return r;if(Symbol.iterator in Object(r))return e(r,t);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();Object.defineProperty(exports,"__esModule",{value:!0});var _events=require("events"),_ndarray=require("ndarray"),_ndarray2=_interopRequireDefault(_ndarray),_ndarrayOps=require("ndarray-ops"),_ndarrayOps2=_interopRequireDefault(_ndarrayOps),_ndarrayPack=require("ndarray-pack"),_ndarrayPack2=_interopRequireDefault(_ndarrayPack),_ndarrayUnpack=require("ndarray-unpack"),_ndarrayUnpack2=_interopRequireDefault(_ndarrayUnpack),_cwise=require("cwise"),_cwise2=_interopRequireDefault(_cwise),_randn=require("./randn"),_randn2=_interopRequireDefault(_randn),_pairwiseDistances=require("./pairwise-distances"),_pairwiseDistances2=_interopRequireDefault(_pairwiseDistances),_jointProbabilities=require("./joint-probabilities"),_jointProbabilities2=_interopRequireDefault(_jointProbabilities),_klDivergence=require("./kl-divergence"),_klDivergence2=_interopRequireDefault(_klDivergence),TSNE=function(e){function r(e){_classCallCheck(this,r);var t=_possibleConstructorReturn(this,Object.getPrototypeOf(r).call(this));return e=e||{},t.dim=e.dim||2,t.perplexity=e.perplexity||30,t.earlyExaggeration=e.earlyExaggeration||4,t.learningRate=e.learningRate||1e3,t.tolerance=e.tolerance||1e-5,t.nIter=e.nIter||1e3,t.metric=e.metric||"euclidean",t.inputData=null,t.outputEmbedding=null,t}return _inherits(r,e),_createClass(r,[{key:"init",value:function(e){e=e||{};var r=e.data||[],t=e.type||"dense";if("dense"===t)this.inputData=(0,_ndarrayPack2["default"])(r);else{if("sparse"!==t)throw new Error("input data type must be dense or sparse");for(var a=[],n=1,i=function(e){var t=Math.max.apply(null,r.map(function(r){return r[e]}))+1;a.push(t),n*=t},u=0;u<r[0].length;u++)i(u);this.inputData=(0,_ndarray2["default"])(new Float64Array(n),a);var s=!0,o=!1,l=void 0;try{for(var d,p=r[Symbol.iterator]();!(s=(d=p.next()).done);s=!0){var c,f=d.value;(c=this.inputData).set.apply(c,_toConsumableArray(f).concat([1]))}}catch(y){o=!0,l=y}finally{try{!s&&p["return"]&&p["return"]()}finally{if(o)throw l}}}this.outputEmbedding=(0,_randn2["default"])(this.inputData.shape[0],this.dim)}},{key:"run",value:function(){this.distances=(0,_pairwiseDistances2["default"])(this.inputData,this.metric),this.alpha=Math.max(this.dim-1,1),this.P=(0,_jointProbabilities2["default"])(this.distances,this.perplexity,this.tolerance);var e=Number.MAX_VALUE,r=0;_ndarrayOps2["default"].mulseq(this.P,this.earlyExaggeration);var t=this._gradDesc(r,50,.5,0,0),a=_slicedToArray(t,2);e=a[0],r=a[1];var n=this._gradDesc(r+1,100,.8,0,0),i=_slicedToArray(n,2);e=i[0],r=i[1],_ndarrayOps2["default"].divseq(this.P,this.earlyExaggeration);var u=this._gradDesc(r+1,this.nIter,.8,1e-6,1e-6),s=_slicedToArray(u,2);return e=s[0],r=s[1],[e,r]}},{key:"rerun",value:function(){this.outputEmbedding=(0,_randn2["default"])(this.inputData.shape[0],this.dim);var e=this.run(),r=_slicedToArray(e,2),t=r[0],a=r[1];return[t,a]}},{key:"getOutput",value:function(){return(0,_ndarrayUnpack2["default"])(this.outputEmbedding)}},{key:"getOutputScaled",value:function(){for(var e=(0,_ndarray2["default"])(new Float64Array(this.outputEmbedding.size),this.outputEmbedding.shape),r=(0,_ndarray2["default"])(new Float64Array(this.outputEmbedding.shape[0]),[this.outputEmbedding.shape[0]]),t=0;t<this.outputEmbedding.shape[1];t++){var a=_ndarrayOps2["default"].sup(_ndarrayOps2["default"].abs(r,this.outputEmbedding.pick(null,t)));_ndarrayOps2["default"].divs(e.pick(null,t),this.outputEmbedding.pick(null,t),a)}return(0,_ndarrayUnpack2["default"])(e)}},{key:"_gradDesc",value:function(e,r,t){var a=arguments.length<=3||void 0===arguments[3]?1e-6:arguments[3],n=arguments.length<=4||void 0===arguments[4]?1e-6:arguments[4],i=30,u=(0,_ndarray2["default"])(new Float64Array(this.outputEmbedding.size),this.outputEmbedding.shape),s=(0,_ndarray2["default"])(new Float64Array(this.outputEmbedding.size).fill(1),this.outputEmbedding.shape),o=Number.MAX_VALUE,l=Number.MAX_VALUE,d=0,p=(0,_cwise2["default"])({args:["array"],pre:function(e){this.sum=0},body:function(e){this.sum+=e*e},post:function(e){return Math.sqrt(this.sum)}}),c=(0,_cwise2["default"])({args:["array","array","array"],body:function(e,r,t){r*t>=0?e+=.05:e*=.95,e=Math.max(e,.01)}}),f=void 0;for(f=e;r>f;f++){var y=(0,_klDivergence2["default"])(this.outputEmbedding,this.P,this.alpha),_=_slicedToArray(y,2),h=_[0],b=_[1],m=Math.abs(h-o);o=h;var g=p(b);if(this.emit("progress",[f,o,g]),l>o)l=o,d=f;else if(f-d>i)break;if(a>=g)break;if(n>=m)break;c(s,u,b),_ndarrayOps2["default"].muleq(b,s);var v=(0,_ndarray2["default"])(new Float64Array(b.size),b.shape);_ndarrayOps2["default"].muls(v,b,this.learningRate),_ndarrayOps2["default"].mulseq(u,t),_ndarrayOps2["default"].subeq(u,v),_ndarrayOps2["default"].addeq(this.outputEmbedding,u)}return[o,f]}}]),r}(_events.EventEmitter);exports["default"]=TSNE;
},{"./joint-probabilities":28,"./kl-divergence":29,"./pairwise-distances":30,"./randn":31,"cwise":2,"events":1,"ndarray":24,"ndarray-ops":11,"ndarray-pack":16,"ndarray-unpack":23}],28:[function(require,module,exports){
"use strict";function _interopRequireDefault(r){return r&&r.__esModule?r:{"default":r}}Object.defineProperty(exports,"__esModule",{value:!0}),exports["default"]=function(r,a,e){for(var t=100,d=r.shape[0],n=(0,_ndarray2["default"])(new Float64Array(d*d),[d,d]),o=(0,_ndarray2["default"])(new Float64Array(d*d),[d,d]),u=void 0,s=void 0,_=1/0,f=0,i=Math.log(a),l=void 0,p=void 0,y=void 0,v=void 0,O=0;d>O;O++){u=1,s=-(1/0),_=1/0;for(var M=0;t>M;M++){for(var N=0;d>N;N++)n.set(O,N,Math.exp(-r.get(O,N)*u));n.set(O,O,0),y=0;for(var N=0;d>N;N++)y+=n.get(O,N);0==y&&(y=EPSILON_DBL),v=0;for(var N=0;d>N;N++)n.set(O,N,n.get(O,N)/y),v+=r.get(O,N)*n.get(O,N);if(p=Math.log(y)+u*v,l=p-i,Math.abs(l)<=e)break;l>0?(s=u,u=_==1/0?2*u:(u+_)/2):(_=u,s==-(1/0)?u/=2:u=(u+s)/2)}f+=u}_ndarrayOps2["default"].add(o,n,n.transpose(1,0));var E=Math.max(_ndarrayOps2["default"].sum(o),MACHINE_EPSILON);return _ndarrayOps2["default"].divseq(o,E),_ndarrayOps2["default"].maxseq(o,MACHINE_EPSILON),o};var _ndarray=require("ndarray"),_ndarray2=_interopRequireDefault(_ndarray),_ndarrayOps=require("ndarray-ops"),_ndarrayOps2=_interopRequireDefault(_ndarrayOps),EPSILON_DBL=1e-7,MACHINE_EPSILON=Number.EPSILON||2.220446049250313e-16;
},{"ndarray":24,"ndarray-ops":11}],29:[function(require,module,exports){
"use strict";function _interopRequireDefault(a){return a&&a.__esModule?a:{"default":a}}Object.defineProperty(exports,"__esModule",{value:!0}),exports["default"]=function(a,r,e){var d=a.shape[0],s=a.shape[1],u=(0,_ndarray2["default"])(new Float64Array(d*d),[d,d]),t=(0,_pairwiseDistances2["default"])(a,"euclidean");square(t);var n=(e+1)/-2;_ndarrayOps2["default"].powseq(_ndarrayOps2["default"].divseq(_ndarrayOps2["default"].addseq(t,1),e),n);for(var l=0;d>l;l++)t.set(l,l,0);var _=Math.max(_ndarrayOps2["default"].sum(t),MACHINE_EPSILON);_ndarrayOps2["default"].divs(u,t,_),_ndarrayOps2["default"].maxseq(u,MACHINE_EPSILON);var i=(0,_ndarray2["default"])(new Float64Array(d*d),[d,d]),p=(0,_ndarray2["default"])(new Float64Array(d*d),[d,d]);_ndarrayOps2["default"].div(i,r,u),_ndarrayOps2["default"].logeq(i),_ndarrayOps2["default"].assign(p,r);var y=_ndarrayOps2["default"].sum(_ndarrayOps2["default"].muleq(i,p)),f=(0,_ndarray2["default"])(new Float64Array(a.size),a.shape),O=(0,_ndarray2["default"])(new Float64Array(d*d),[d,d]);_ndarrayOps2["default"].sub(O,r,u),_ndarrayOps2["default"].muleq(O,t);for(var l=0;d>l;l++)for(var o=0;s>o;o++){var q=(0,_ndarray2["default"])(new Float64Array(a.shape[0]),[a.shape[0]]);_ndarrayOps2["default"].assign(q,a.pick(null,o)),_ndarrayOps2["default"].addseq(_ndarrayOps2["default"].negeq(q),a.get(l,o)),_ndarrayOps2["default"].muleq(q,O.pick(l,null)),f.set(l,o,_ndarrayOps2["default"].sum(q))}var c=2*(e+1)/e;return _ndarrayOps2["default"].mulseq(f,c),[y,f]};var _ndarray=require("ndarray"),_ndarray2=_interopRequireDefault(_ndarray),_ndarrayOps=require("ndarray-ops"),_ndarrayOps2=_interopRequireDefault(_ndarrayOps),_cwise=require("cwise"),_cwise2=_interopRequireDefault(_cwise),_pairwiseDistances=require("./pairwise-distances"),_pairwiseDistances2=_interopRequireDefault(_pairwiseDistances),MACHINE_EPSILON=Number.EPSILON||2.220446049250313e-16,square=(0,_cwise2["default"])({args:["array"],body:function(a){a*=a}});
},{"./pairwise-distances":30,"cwise":2,"ndarray":24,"ndarray-ops":11}],30:[function(require,module,exports){
"use strict";function _interopRequireDefault(r){return r&&r.__esModule?r:{"default":r}}Object.defineProperty(exports,"__esModule",{value:!0}),exports["default"]=function(r,t){var e=r.shape[0],a=(0,_ndarray2["default"])(new Float64Array(e*e),[e,e]);switch(t){case"euclidean":for(var i=0;e>i;i++)for(var s=i+1;e>s;s++){var u=euclidean(r.pick(i,null),r.pick(s,null));a.set(i,s,u),a.set(s,i,u)}break;case"jaccard":for(var i=0;e>i;i++)for(var s=i+1;e>s;s++){var u=jaccard(r.pick(i,null),r.pick(s,null));a.set(i,s,u),a.set(s,i,u)}}return a};var _ndarray=require("ndarray"),_ndarray2=_interopRequireDefault(_ndarray),_cwise=require("cwise"),_cwise2=_interopRequireDefault(_cwise),euclidean=(0,_cwise2["default"])({args:["array","array"],pre:function(r,t){this.sum=0},body:function(r,t){var e=r-t;this.sum+=e*e},post:function(r,t){return Math.sqrt(this.sum)}}),jaccard=(0,_cwise2["default"])({args:["array","array"],pre:function(r,t){this.tf=0,this.tt=0},body:function(r,t){this.tf+=+(r!=t),this.tt+=+(1==r&&1==t)},post:function(r,t){return this.tf+this.tt===0?1:this.tf/(this.tf+this.tt)}});
},{"cwise":2,"ndarray":24}],31:[function(require,module,exports){
"use strict";function _interopRequireDefault(r){return r&&r.__esModule?r:{"default":r}}function gaussRandom(){var r=2*Math.random()-1,a=2*Math.random()-1,e=r*r+a*a;return 0==e||e>1?gaussRandom():r*Math.sqrt(-2*Math.log(e)/e)}Object.defineProperty(exports,"__esModule",{value:!0}),exports["default"]=function(r,a){for(var e=new Float64Array(r*a),t=0;t<e.length;t++)e[t]=1e-4*gaussRandom();return(0,_ndarray2["default"])(e,[r,a])};var _ndarray=require("ndarray"),_ndarray2=_interopRequireDefault(_ndarray);
},{"ndarray":24}]},{},[27])(27)
});TSNE=TSNE.default

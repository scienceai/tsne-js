...
"use strict";function _interopRequireDefault(r){return r&&r.__esModule?r:{"default":r}}Object.defineProperty(exports,"__esModule",{value:!0}),exports["default"]=function(r,a){for(var e=100,t=r.shape[0],d=(0,_ndarray2["default"])(new Float64Array(t*t),[t,t]),n=(0,_ndarray2["default"])(new Float64Array(t*t),[t,t]),o=void 0,u=void 0,_=1/0,s=0,f=Math.log(a),i=void 0,l=void 0,p=void 0,y=void 0,E=0;t>E;E++){o=1,u=-(1/0),_=1/0;for(var O=0;e>O;O++){for(var v=0;t>v;v++)d.set(E,v,Math.exp(-r.get(E,v)*o));d.set(E,E,0),p=0;for(var v=0;t>v;v++)p+=d.get(E,v);0==p&&(p=EPSILON_DBL),y=0;for(var v=0;t>v;v++)d.set(E,v,d.get(E,v)/p),y+=r.get(E,v)*d.get(E,v);if(l=Math.log(p)+o*y,i=l-f,Math.abs(i)<=PERPLEXITY_TOLERANCE)break;i>0?(u=o,o=_==1/0?2*o:(o+_)/2):(_=o,u==-(1/0)?o/=2:o=(o+u)/2)}s+=o}_ndarrayOps2["default"].add(n,d,d.transpose(1,0));var L=Math.max(_ndarrayOps2["default"].sum(n),MACHINE_EPSILON);return _ndarrayOps2["default"].divseq(n,L),_ndarrayOps2["default"].maxseq(n,MACHINE_EPSILON),n};var _ndarray=require("ndarray"),_ndarray2=_interopRequireDefault(_ndarray),_ndarrayOps=require("ndarray-ops"),_ndarrayOps2=_interopRequireDefault(_ndarrayOps),EPSILON_DBL=1e-7,MACHINE_EPSILON=Number.EPSILON||2.220446049250313e-16,PERPLEXITY_TOLERANCE=1e-5;
